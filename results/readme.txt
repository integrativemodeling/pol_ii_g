...
_Clustering/cluster_run1_models.tar.xz_: models in cluster from run1 [run number 1 to 50]. 

_Clustering/cluster_run2_models.tar.xz_: models in cluster from run2 [run number 51 to 100]. 
